...
public class UsageHistoryService {
    ...
    public void startWork(ComputerDto computerDto) {
        UsageHistoryEntity history = UsageHistoryEntity.builder().user_id(computerDto.getUserId()).start(new Date()).stop(null).computerId(computerDto.getComputerId()).build();
